(function ($) {
	...
	$(window).on('load', function () {
		...
		if ($('.portfolio-grid-loadmore').length > 0) {
			...
			$portfolioGridContainer.after('<div class="text-center"><a href="#" id="load-more" class="loadmore-btn"><i class="icon icon-plus"></i> Load More</a></div>');
